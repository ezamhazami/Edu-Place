...
$categories = ['Math', 'Physics', 'English', 'Computer Science'];
...
<body>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                ...
                <li><a href="tuto_subscription.php" class="<?php if ($current_page == 'tuto_subsciption.php') echo 'active'; ?>">Tutor Subscription</a></li>
            </ul>
        </nav>
    </div>
    ...
    <main>
        ...
        <form method="GET" class="category-select">
...
<?php if ($selected_category): ?>
    <div class="tutor-list">
        <h2>Tutors in <?= htmlspecialchars($selected_category) ?></h2>
        <?php
        $found = false;
        foreach ($tutors as $tutor) {
            if ($tutor['category'] === $selected_category) {
                $found = true;
                ?>
                <div class="tutor-item">
                    ...
                    <form method="POST" action="payment.php">
                        <input type="hidden" name="tutor_name" value="<?= htmlspecialchars($tutor['name']) ?>">
                        <input type="hidden" name="category" value="<?= htmlspecialchars($tutor['category']) ?>">
        ...
        if (!$found) {
            echo "<p>No tutors found in this category.</p>";
        }
        ?>
    </div>
<?php endif; ?>
